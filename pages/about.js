    ...
    return (
      <div className="syn-content" style={{ maxWidth: 600, margin: "30px auto" }}>
        ...
        <div className="syn-bio">
          ...
          Mình là Thắng. Mình xuất thân từ một người chuyên tự nhiên vì thế văn mình khá kém.
          Vậy nên mình đã tạo blog này để tập viết, tập note lại những gì mình đã nghiên cứu được để hiểu sâu vấn đề hơn.
          ...
          Nên mình cũng rất mong muốn được chia sẻ kiến thức của mình đến tất mọi người.<br /><br />

          Và tất nhiên với một newbie như mình thì việc hiểu sai vấn đề là chuyện bình thường.
          Mình còn trẻ trâu nữa nên khó tránh khỏi những sai lầm. :))
